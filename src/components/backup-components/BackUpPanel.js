        ...
        this.state = {
            works: [
                ...
                //-------
                {
                    ...
                    category: "M.S Project",
                    text: "This project is a series of project assignments in the linear algebra application course. In this class, we first recognize and implement the errors or bottlenecks that may be caused by data types or division operations when the computer performs mathematical operations, and then we implement and compares different matrix decomposition using a C++ linear algebra calculation library, Eigen,  methods. Finally, we use these decomposition methods to complete the implementation of image compression.",
                    ...
                    title: "線性代數應用與數值方法實作",
                    category: "M.S Project",
                    text: "本專案為線性代數應用課程的一系列專題作業，在本課堂中我們首先認識並實作了電腦進行數學運算時可能因為資料型態或除法運算造成的錯誤或瓶頸，接著我們使用了C++的線性代數運算庫Eigen實現並比較了不同的矩陣分解方法，最終我們則實際運用這些分解方式完成了影像壓縮壓縮處理的實作。",
                    tools: "C++ Eigen Python Matplotlib",
                    year: "2021",
                    downloadlink: "https://drive.google.com/file/d/1xAEAr-CK3KuM_K2vSBcg8WFmFR3jkjZa/view?usp=sharing",
                    pictureone: `http://${process.env.REACT_APP_API_ADDRESS}/static/backup/ms_230/ms_230_1.png`,
